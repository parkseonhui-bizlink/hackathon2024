...
const roleOptions = ['フロントエンド', 'バックエンド', 'デザイナー', 'その他'];
...
export function Page({
  ...
  const handleSubmit = () => {
    ...
    searchParams.set('selectedRoles', JSON.stringify(roleSelections));
                ...
                {roleSelections.map((selection, index) => (
                  <div key={index} className="flex items-center space-x-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleRoleChange(index, 'count', value)
                      }
                    >
                    ...
                    {index === roleSelections.length - 1 ? (
                      ...
                      <Button
                        ...
                        variant="outline"
                        size="icon"
                        onClick={() => removeRoleSelection(index)}
                      >
